...
export const AvatarCropModal: React.FC<AvatarCropModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 bg-black/90 backdrop-blur-md z-60 flex items-center justify-center p-3 sm:p-4">
      <div className="bg-stone-900 border border-stone-800 rounded-3xl p-5 sm:p-6 max-w-md w-full shadow-2xl space-y-4 animate-in zoom-in-95 duration-150 flex flex-col">
        {/* Header */}
        ...
        <div className="flex items-center justify-end space-x-2 pt-1">
          ...
          <button
            ...
            className="py-2.5 px-5 rounded-xl bg-amber-500 hover:bg-amber-400 text-stone-950 font-bold text-xs flex items-center gap-1.5 transition cursor-pointer shadow-md"
          >
