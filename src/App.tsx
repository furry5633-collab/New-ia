...
function InfinityLogo({ className = 'w-6 h-6' }: { className?: string }) {
  return (
    <svg
      viewBox="0 0 100 50"
      className={className}
    ...
    >
      ...
      <path
        d="M 30 25 C 16 10 0 16 0 25 C 0 34 16 40 30 25 C 44 10 56 10 70 25 C 84 40 100 34 100 25 C 100 16 84 10 70 25 C 56 40 44 40 30 25 Z"
...
export default function App() {
  ...
  return (
    <div className="fixed inset-0 w-full h-full flex bg-stone-950 text-stone-100 overflow-hidden font-sans select-none">
      ...
      <aside
        className={`fixed inset-y-0 left-0 z-50 w-72 bg-stone-900 border-r border-stone-800 flex flex-col transition-transform duration-200 ease-in-out ${
          isSidebarOpen ? 'translate-x-0' : '-translate-x-full'
        }`}
      >
        <div className="p-3.5 border-b border-stone-800 flex items-center justify-between shrink-0">
          <div className="flex items-center space-x-2">
            <div className="w-8 h-8 rounded-xl bg-stone-950 border border-stone-800 flex items-center justify-center shadow-xs">
              <InfinityLogo className="w-6 h-4" />
            </div>
            <div>
      ...
      <div className="flex-1 flex flex-col min-w-0 h-full w-full overflow-hidden relative">
        ...
        <header className="h-14 border-b border-stone-850 bg-stone-950/90 backdrop-blur-md px-4 flex items-center justify-between shrink-0 select-none z-20">
          <div className="flex items-center space-x-3">
            ...
            <div className="flex items-center space-x-2">
              <div className="w-8 h-8 rounded-lg bg-stone-900 border border-stone-800 flex items-center justify-center shadow-xs">
                <InfinityLogo className="w-6 h-4" />
              </div>
        ...
        <div className="flex-1 overflow-y-auto overflow-x-hidden px-3 sm:px-6 md:px-12 lg:px-24 py-4 sm:py-6 space-y-6 min-h-0">
          {messages.length === 0 ? (
            <motion.div
              ...
              className="h-full flex flex-col items-center justify-center text-center max-w-md mx-auto py-8 px-4 space-y-4"
            >
              <div className="w-16 h-16 rounded-2xl bg-stone-900 border border-stone-800 flex items-center justify-center shadow-lg">
                <InfinityLogo className="w-12 h-8" />
              </div>
              ...
              <p className="text-xs sm:text-sm text-stone-400 leading-relaxed font-sans">
                Escribe varias operaciones o pulsa <kbd className="px-1.5 py-0.5 rounded bg-stone-800 text-stone-300 border border-stone-700 font-mono text-xs">+</kbd> para capturar una <strong className="text-amber-300">página entera</strong> con la cámara en vertical.
              </p>
            </motion.div>
          ) : (
                ...
                >
                  {isTutor && (
                    <div className="w-8 h-8 rounded-xl bg-stone-900 border border-stone-800 flex items-center justify-center shrink-0 mt-1 shadow-xs">
                      <InfinityLogo className="w-5 h-3" />
                    </div>
                  )}
          ...
          {isLoading && (
            ...
            >
              <div className="w-8 h-8 rounded-xl bg-stone-900 border border-stone-800 flex items-center justify-center shrink-0 shadow-xs">
                <InfinityLogo className="w-5 h-3 animate-pulse" />
              </div>
        ...
        <div className="p-3 sm:p-4 bg-stone-950 border-t border-stone-900 shrink-0 z-20">
          <div className="max-w-3xl mx-auto relative">
            ...
            {isMenuOpen && (
              <div className="absolute bottom-14 left-0 w-64 bg-stone-900 border border-stone-800 rounded-2xl shadow-2xl p-2 z-50 animate-in fade-in slide-in-from-bottom-2 duration-150 text-stone-200">
      ...
      {isOnboardingOpen && (
        <div className="fixed inset-0 bg-black/90 backdrop-blur-md z-50 flex items-center justify-center p-3 sm:p-4">
          <div className="bg-stone-900 border border-stone-800 rounded-3xl p-6 sm:p-7 max-w-lg w-full shadow-2xl space-y-5 animate-in zoom-in-95 duration-200">
            {/* Header */}
      ...
      {isProfileModalOpen && (
        <div className="fixed inset-0 bg-black/85 backdrop-blur-sm z-50 flex items-center justify-center p-3 sm:p-4">
          <div className="bg-stone-900 border border-stone-800 rounded-3xl max-w-lg w-full shadow-2xl overflow-hidden animate-in zoom-in-95 duration-150 flex flex-col">
      ...
      {isPhotoChoiceModalOpen && (
        <div className="fixed inset-0 bg-black/85 backdrop-blur-md z-50 flex items-center justify-center p-4">
          <div className="bg-stone-900 border border-stone-800 rounded-3xl p-5 sm:p-6 max-w-sm w-full shadow-2xl space-y-4 animate-in zoom-in-95 duration-150">
            ...
            <div className="space-y-2.5 pt-1">
              ...
              <button
                ...
                className="w-full p-3.5 rounded-2xl bg-stone-950 hover:bg-stone-850 border border-stone-800 hover:border-amber-500/50 text-left flex items-center space-x-3.5 transition group cursor-pointer"
              >
            ...
            <div className="pt-1 flex justify-center">
              <button
                type="button"
                onClick={() => setIsPhotoChoiceModalOpen(false)}
                className="text-xs text-stone-500 hover:text-stone-300 transition py-1"
              >
                Cancelar
              </button>
            </div>
      ...
      {isAvatarPickerOpen && (
        <div className="fixed inset-0 bg-black/90 backdrop-blur-md z-50 flex items-center justify-center p-3 sm:p-4">
          <div className="bg-stone-900 border border-stone-800 rounded-3xl p-4 sm:p-6 max-w-2xl w-full shadow-2xl space-y-3.5 max-h-[92vh] flex flex-col animate-in zoom-in-95 duration-150">
            {/* Modal Header */}
